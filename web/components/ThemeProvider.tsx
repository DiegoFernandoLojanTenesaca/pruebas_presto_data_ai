...
const translations: Record<string, Record<Lang, string>> = {
  ...
  antiabandono: { es: "Anti-abandono", en: "Anti-churn" },
  scoring: { es: "Scoring", en: "Scoring" },
  clasificar: { es: "Clasificar", en: "Classify" },
  streaming: { es: "Streaming", en: "Streaming" },
  transcribir: { es: "Audio", en: "Audio" },
  abtest: { es: "A/B Test", en: "A/B Test" },
  ...
  "mod_08_title": { es: "Dashboard de Metricas", en: "Metrics Dashboard" },
  "mod_08_desc": { es: "Eventos en tiempo real, funnel del lead, donut de scoring y latencia por endpoint.", en: "Real-time events, lead funnel, scoring donut and latency per endpoint." },
  "mod_09_title": { es: "Anti-abandono — Salvavidas", en: "Anti-churn — Lifesaver" },
  "mod_09_desc": { es: "Detecta cuando un lead va a irse y propone un mensaje personalizado para reengancharlo.", en: "Detects when a lead is about to leave and proposes a personalized message to re-engage." },
  "mod_10_title": { es: "Lead Scoring (LLM-as-judge)", en: "Lead Scoring (LLM-as-judge)" },
  "mod_10_desc": { es: "Califica conversaciones 0-100. Categoria frio/tibio/caliente con justificacion y siguiente accion.", en: "Score conversations 0-100. Cold/warm/hot category with justification and next action." },
  "mod_11_title": { es: "Clasificacion Zero-Shot", en: "Zero-Shot Classification" },
  "mod_11_desc": { es: "Intencion + sentimiento + urgencia + idioma sin entrenar. Modo individual o batch con analitica.", en: "Intent + sentiment + urgency + language without training. Single or batch mode with analytics." },
  "mod_12_title": { es: "A/B Test de Prompts", en: "Prompt A/B Test" },
  "mod_12_desc": { es: "Compara dos versiones del prompt con LLM imparcial. Veredicto por criterios y recomendacion.", en: "Compare two prompt versions with impartial LLM. Verdict by criteria and recommendation." },
  "mod_13_title": { es: "Streaming SSE — Tokens en vivo", en: "SSE Streaming — Live tokens" },
  "mod_13_desc": { es: "El LLM responde token por token, con metricas de TTF (time to first token) y velocidad.", en: "LLM responds token by token, with TTF (time to first token) and speed metrics." },
  "mod_14_title": { es: "Transcripcion Audio — Whisper", en: "Audio Transcription — Whisper" },
  "mod_14_desc": { es: "Sube o graba audio. Whisper transcribe y clasificamos automaticamente intencion + sentimiento.", en: "Upload or record audio. Whisper transcribes and we auto-classify intent + sentiment." },
